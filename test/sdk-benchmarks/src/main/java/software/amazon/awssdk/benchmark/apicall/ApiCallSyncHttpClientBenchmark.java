...
public class ApiCallSyncHttpClientBenchmark extends SdkBaseBenchmark {
    ...
    public static void main(String... args) throws Exception {
        ...
        Options opt = new OptionsBuilder()
            .include(ApiCallSyncHttpClientBenchmark.class.getSimpleName())
            .param("clientType", "ApacheHttpClient")
